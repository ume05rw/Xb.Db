...
namespace TestsXb
{
    ...
    public class MsSqlColumnTests : MsSqlBase, IDisposable
    {
        ...
        public void ValidateTest()
        {
            ...
            Xb.Db.Model.ErrorType errType;

            col = this._testModel.GetColumn("COL_STR");
            Assert.AreEqual(Xb.Db.Model.ErrorType.NoError, col.Validate("a"));
            Assert.AreEqual(Xb.Db.Model.ErrorType.NoError, col.Validate("あ"));
            Assert.AreEqual(Xb.Db.Model.ErrorType.NoError, col.Validate("@"));
            Assert.AreEqual(Xb.Db.Model.ErrorType.NoError, col.Validate("1234567890"));
            Assert.AreEqual(Xb.Db.Model.ErrorType.NoError, col.Validate("１２３４５"));

            Assert.AreEqual(Xb.Db.Model.ErrorType.NotPermittedNull, col.Validate(null));
            Assert.AreEqual(Xb.Db.Model.ErrorType.LengthOver, col.Validate("12345678901"));
            Assert.AreEqual(Xb.Db.Model.ErrorType.LengthOver, col.Validate("１２３４５6"));

            col = this._testModel.GetColumn("COL_DEC");
            Assert.AreEqual(Xb.Db.Model.ErrorType.NoError, col.Validate(1));
            Assert.AreEqual(Xb.Db.Model.ErrorType.NoError, col.Validate(12));
            Assert.AreEqual(Xb.Db.Model.ErrorType.NoError, col.Validate(12.3));
            Assert.AreEqual(Xb.Db.Model.ErrorType.NoError, col.Validate(12.34));
            Assert.AreEqual(Xb.Db.Model.ErrorType.NoError, col.Validate(12.345));
            Assert.AreEqual(Xb.Db.Model.ErrorType.NoError, col.Validate(99.999));
            Assert.AreEqual(Xb.Db.Model.ErrorType.NoError, col.Validate(-99.999));
            Assert.AreEqual(Xb.Db.Model.ErrorType.NoError, col.Validate("99.999"));
            Assert.AreEqual(Xb.Db.Model.ErrorType.NoError, col.Validate("-99.999"));
            Assert.AreEqual(Xb.Db.Model.ErrorType.DecimalOver, col.Validate(12.3456));
            Assert.AreEqual(Xb.Db.Model.ErrorType.DecimalOver, col.Validate(-12.3456));
            Assert.AreEqual(Xb.Db.Model.ErrorType.NotNumber, col.Validate("a"));
            Assert.AreEqual(Xb.Db.Model.ErrorType.NoError, col.Validate(null));
            col = this._test3Model.GetColumn("COL_INT");
            Assert.AreEqual(Xb.Db.Model.ErrorType.NoError, col.Validate(12));
            Assert.AreEqual(Xb.Db.Model.ErrorType.NoError, col.Validate(-12));
            Assert.AreEqual(Xb.Db.Model.ErrorType.DecimalOver, col.Validate(12.3));
            Assert.AreEqual(Xb.Db.Model.ErrorType.DecimalOver, col.Validate(-12.3));
            Assert.AreEqual(Xb.Db.Model.ErrorType.NotPermittedNull, col.Validate(null));

            col = this._test3Model.GetColumn("COL_DATETIME");
            Assert.AreEqual(Xb.Db.Model.ErrorType.NoError, col.Validate(new DateTime(2000, 1, 1)));
            Assert.AreEqual(Xb.Db.Model.ErrorType.NoError, col.Validate("1900-1-1"));
            Assert.AreEqual(Xb.Db.Model.ErrorType.NoError, col.Validate("2000/1/1"));
            Assert.AreEqual(Xb.Db.Model.ErrorType.NotDateTime, col.Validate("2010/19/19"));
            Assert.AreEqual(Xb.Db.Model.ErrorType.NoError, col.Validate("2000/1/1 1:1:1"));
            Assert.AreEqual(Xb.Db.Model.ErrorType.NoError, col.Validate("2000/1/1 23:59:59"));
            Assert.AreEqual(Xb.Db.Model.ErrorType.NotDateTime, col.Validate("2000/1/1 24:59:59"));
        }
